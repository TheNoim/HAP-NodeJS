...
function loadDirectory(dir, callback) {
    ...
    /*
     ...
     loadedAccessories.initAccFactory(function () {
     accessories = accessories.concat(loadedAccessories);
     });
     }
     });*/
    readDirAsync(dir, function () {
        //accessories.clean(null);
        //co('info', 'Fertig. JSON Länge: ' + JSON.stringify(accessories));
        callback(accessories.map(function (accessory) {
    ...
    fs.readdir(dir, function (err, files) {
        files.forEach(function (file, index) {
            ...
            // "Accessory Factories" are modules that export an array of accessories.
                ...
                var loadedAccessories = require(path.join(dir, file));
                loadedAccessories.initAccFactory(function () {
                    accessories = accessories.concat(loadedAccessories.accessories);
                    callback();
                });
            }
        });
